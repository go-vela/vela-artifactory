...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		&cli.StringFlag{
			...
			FilePath: "/vela/parameters/artifactory/api_key,/vela/secrets/artifactory/api_key,/vela/secrets/auth/api_key",
			Name:     "config.api_key",
			Usage:    "API key for communication with the Artifactory instance",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_TOKEN", "ARTIFACTORY_TOKEN"},
			FilePath: "/vela/parameters/artifactory/token,/vela/secrets/artifactory/token,/vela/secrets/auth/token",
			Name:     "config.token",
		...
		&cli.StringFlag{
			...
			FilePath: "/vela/parameters/artifactory/password,/vela/secrets/artifactory/password,/vela/secrets/auth/password",
		...
		&cli.StringFlag{
			...
			FilePath: "/vela/parameters/artifactory/username,/vela/secrets/artifactory/username,/vela/secrets/auth/username",

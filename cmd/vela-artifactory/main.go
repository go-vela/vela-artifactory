...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/secrets/artifactory/flat,/vela/secrets/parameter/flat"),
			Name:     "copy.flat",
			Usage:    "enables removing source directory hierarchy",
		},
		&cli.BoolFlag{
			EnvVars:  []string{"PARAMETER_RECURSIVE", "COPY_RECURSIVE"},
			FilePath: string("/vela/secrets/artifactory/recursive,/vela/secrets/parameter/recursive"),
			Name:     "copy.recursive",
			Usage:    "enables copying sub-directories for the artifact(s)",
		},
		&cli.StringFlag{
			EnvVars:  []string{"PARAMETER_TARGET", "COPY_TARGET"},
			FilePath: string("/vela/secrets/artifactory/target,/vela/secrets/parameter/target"),
			Name:     "copy.target",
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/artifactory/target_repo,/vela/secrets/parameter/target_repo"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/artifactory/target_docker_registry,/vela/secrets/parameter/target_docker_registry"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/artifactory/tag,/vela/secrets/parameter/tag"),
		...
		&cli.StringSliceFlag{
			...
			FilePath: string("/vela/secrets/artifactory/target_tags,/vela/secrets/parameter/target_tags"),
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/secrets/artifactory/copy,/vela/secrets/parameter/copy"),
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/secrets/artifactory/promote,/vela/secrets/parameter/promote"),
		...
		&cli.StringFlag{
			...
			FilePath: string("/vela/secrets/artifactory/props,/vela/secrets/parameter/props"),
			Name:     "set_prop.props",
		...
		&cli.BoolFlag{
			...
			FilePath: string("/vela/secrets/artifactory/include_dirs,/vela/secrets/parameter/include_dirs"),
			Name:     "upload.include_dirs",
			Usage:    "enables including directories from sources",
		},
		&cli.BoolFlag{
			EnvVars:  []string{"PARAMETER_REGEXP", "UPLOAD_REGEXP"},
			FilePath: string("/vela/secrets/artifactory/regexp,/vela/secrets/parameter/regexp"),
			Name:     "upload.regexp",
		...
		&cli.StringSliceFlag{
			...
			FilePath: string("/vela/secrets/artifactory/sources,/vela/secrets/parameter/sources"),
			Name:     "upload.sources",
